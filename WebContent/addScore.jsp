				...
				<table>
				     <tr>
					    <td><label for="ProgressID">Enter Progress Id:</label> </td>
						 <td><input type ="text" name="ProgressID" placeholder="Enter progress Id"> </td>
					</tr>
					 <tr>	
						<td><label for="Evalution">Enter Evaluation:</label> </td>
						<td><input type ="text" name="Evalution" placeholder="Enter Evaluation"> </td>
					</tr>
					 <tr>
						...
						<td><input type ="text" name="EventID" placeholder="Enter Event Id"></td>
					 <tr>
						
						<td><label for="ElemetID">Enter Element Id:</label> </td>
						<td><input type ="text" name="ElemetID" placeholder="Enter Element Id"></td>
					 </tr>
					 <tr>
						<td><label for="AthleteID">Enter Athlete Id:</label> </td>
						<td><input type ="text" name="AthleteID" placeholder="Enter Athlete Id"></td>
					</tr>	
				</table>
