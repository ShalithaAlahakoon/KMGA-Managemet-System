...
@WebServlet("/UpdatePreparationServlet")
public class UpdatePreparationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isSuccess = TS_DButil.updatePreparation(prepID, name, Integer.parseInt(set1), Integer.parseInt(reps));
		if(isSuccess == true) {
		...
		else
		{
			...
			set.println("alert(' UPDATED UNSUCCESSFULL ');");
