...
<div class="main">
	...
	<h2>DELETE DETAILS</h2>
			...
			<div class="user-box">
				<label>In Time:</label>
				<input type="text" name="inTime" value ="<%= request.getParameter("inTime") %>" readonly>
			</div>
			<div class="user-box">
				<label>Out Time:</label>
				<input type="text" name="outTime" value="<%= request.getParameter("outTime") %>" readonly>
			</div>
			<div class="user-box">
				<label>Date:</label>
			...
			<div>
				<input type="submit" name="btnsubmit" id="submit"  value="Delete Details" class="btn btn-success">
			</div>
