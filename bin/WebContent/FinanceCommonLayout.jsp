...
<body>
	...
	<div class="HeaderArea">
		...
		<div class="row">
	    	...
	    	<div class="col-sm-6">
	    	<br>
	    		<h3>FINANCE MANAGEMENT</h3>   <!-- Function name -->
		  		<br>
	...
	<!-- Side navigation -->
	<div class="sidenav">s
	  <a href="InsertFinance.jsp">ADD NEW RECORDS</a>
	  <a href="ViewLedger.jsp">VIEW LEDGER</a>
	  <a href="GenerateFinanceReport.jsp">GENERATE REPORT</a>
